				...
				<div class="px-4">
					...
					<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
						<div class="border rounded-lg overflow-hidden hover:shadow-lg transition">
							...
							<div class="p-6">
								<span class="text-xs text-red-500 font-semibold uppercase">
									News
								</span>
								...
								<p class="mt-3 text-gray-500 text-sm">
									Look stylish with minimal effort using versatile basics
									perfect for everyday wear.
								</p>

								<a
									href="#"
									class="inline-block mt-4 text-sm font-semibold text-gray-900 hover:underline"
								>
									Read More
								</a>
							</div>
						...
						<div class="border rounded-lg overflow-hidden hover:shadow-lg transition">
							...
							<div class="p-6">
								...
								<p class="mt-3 text-gray-500 text-sm">
									From jackets to shirts, oversized pieces bring comfort and
									modern edge.
								</p>
